---
title: "解决 Actor 记忆冲突"
description: "对某个 Actor 事实之间的记忆冲突应用解决策略"
---
...
<RequestExample>
```bash 保留特定事实
curl -X POST 'https://app.memorylake.cn/openapi/memorylake/api/v3/workspaces/ws_abc123/actors/act-a1b2c3d4e5f6/memories/conflicts/conf-def456/resolve' \
